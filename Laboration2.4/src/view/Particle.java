...
public class Particle {
	...
	public void respawn(float startPosX, float startPosY) {
		...
		this.yi = (rand.nextFloat() - -1.0f) * 10.0f;
	...
	public void draw(GLAutoDrawable drawable, Core core, Camera camera) {
			...
			float viewX = camera.toViewCoord(x-0.3f);
			float viewY = camera.toViewCoord(y+3.0f);
